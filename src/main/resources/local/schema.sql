...
CREATE PROCEDURE `card_by_id`(IN id varchar(16), out cardNumber varchar(16), out personId varchar(8))
BEGIN
...
$$
CREATE PROCEDURE `get_person_by_id`(IN id varchar(8))
BEGIN
...
$$
CREATE PROCEDURE `get_card_by_user_id`(IN personId varchar(8))
BEGIN
